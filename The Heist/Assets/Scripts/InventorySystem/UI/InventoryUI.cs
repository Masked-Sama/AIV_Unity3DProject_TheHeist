...
public class InventoryUI : VisualElement
{
    ...
    public new class UxmlTraits : VisualElement.UxmlTraits
    {
        ...
        public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)    //linko i valori che andr� a inserire con i valori della classe PointBar
        {
            base.Init(ve, bag, cc);
    ...
    public void AddToSlotItem(int index, IInventoried itemObjToSwitch, int amount)
    {
        ...
        if (slot == null) return;
        //condizione brutta per dire che hai gi� l'arma raccolta nell'inventario
